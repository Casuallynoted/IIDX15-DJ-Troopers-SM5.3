return Def.ActorFrame {
	...
	LoadActor("ACTIVE_LINE1")..{
		InitCommand=cmd(playcommand,"Set";blend,'BlendMode_Add';diffusealpha,0;;x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y-65;zoomtowidth,SCREEN_WIDTH);
	...
	LoadActor("ACTIVE_LINE2")..{
		InitCommand=cmd(playcommand,"Set";blend,'BlendMode_Add';diffusealpha,0;;x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y+10;zoomtowidth,SCREEN_WIDTH);
		CurrentSongChangedMessageCommand=cmd(finishtweening;playcommand,"Set"),
		SetCommand=function(self)
			self:diffusealpha(1)
			self:sleep(0.08)
	...
	LoadActor("ACTIVE_LINE3")..{
		InitCommand=cmd(playcommand,"Set";blend,'BlendMode_Add';diffusealpha,0;;x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y-39;zoomtowidth,SCREEN_WIDTH);
		CurrentSongChangedMessageCommand=cmd(finishtweening;playcommand,"Set"),
		SetCommand=function(self)
			self:diffusealpha(1)
			self:sleep(0.08)
