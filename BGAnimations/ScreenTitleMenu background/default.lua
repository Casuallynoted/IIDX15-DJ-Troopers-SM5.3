local t = Def.ActorFrame {
	LoadActor(THEME:GetPathS("","_title.ogg"))..{
		OnCommand=cmd(play);
		OffCommand=cmd(stop);
	};
	...
	LoadActor("WHITE_GLOW")..{
		InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y);
		OnCommand=cmd(blend,'BlendMode_Add';diffusealpha,0;sleep,1.2;linear,0.2;diffusealpha,0.8;linear,0.3;addy,-35);
	};
	-- [Layer13]
	LoadActor("LOGO.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y);
		OnCommand=cmd(zoomx,40;diffusealpha,0;sleep,1;linear,0.1;diffusealpha,1;zoomx,1;sleep,0.3;linear,0.3;addy,-35;sleep,0;diffusealpha,0);
	};
	-- [Layer14]
	LoadActor("LOGO_WIRE.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X-4;y,SCREEN_CENTER_Y);
		OnCommand=cmd(blend,'BlendMode_Add';diffusealpha,0.8;cropright,1;linear,0.8;cropright,0;linear,0.2;diffusealpha,0.5;sleep,0.4;linear,0.3;addy,-35;diffusealpha,0);
	};
	-- [Layer15]
	LoadActor("WIRE_DJ.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X-183;y,SCREEN_CENTER_Y);
		OnCommand=cmd(blend,'BlendMode_Add';zoom,3.4;diffusealpha,0;sleep,0.2;linear,0.2;zoom,1;diffusealpha,0.8;sleep,0.4;linear,0.2;diffusealpha,0.5;sleep,0.4;linear,0.3;addy,-35;diffusealpha,0);
	};
	-- [Layer16]
	LoadActor("WIRE_2DX.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X+45;y,SCREEN_CENTER_Y-53);
		OnCommand=cmd(blend,'BlendMode_Add';diffusealpha,0.8;cropright,1;sleep,0.5;linear,0.3;cropright,0;linear,0.2;diffusealpha,0.4;sleep,0.4;linear,0.3;addy,-35;diffusealpha,0);
	};
	-- [Layer18]
	LoadActor("WIRE_TROOPERS.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X+46;y,SCREEN_CENTER_Y+30);
		OnCommand=cmd(blend,'BlendMode_Add';diffusealpha,0.8;cropright,1;sleep,0.6;linear,0.3;cropright,0;linear,0.1;diffusealpha,0.4;sleep,0.4;linear,0.3;addy,-35;diffusealpha,0);
	};
	...
	LoadActor("CREDIT.png")..{
		...
		OnCommand=cmd(addy,-10;diffusealpha,0;sleep,1.6;linear,0.2;addy,10;diffusealpha,1);
	};
	-- [Layer46]
	LoadActor("WHITE_GLOW.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y);
		OnCommand=cmd(blend,'BlendMode_Add';addy,-35;diffusealpha,0;sleep,2;diffusealpha,0.8);
	};
	-- [Layer47]
	LoadActor("logo.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y-35);
		OnCommand=cmd(diffusealpha,0;sleep,1.7;diffusealpha,1;);
	};
	-- [Layer48]
	LoadActor("LOGO_BASE.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y-35);
		OnCommand=cmd(diffusealpha,0;playcommand,"Animate");
		AnimateCommand=cmd(diffusealpha,0;sleep,3;linear,0.2;diffusealpha,0.8;sleep,1.5;linear,0.3;diffusealpha,0;queuecommand,"Animate");
	};
	-- [Layer49]
	...
	-- [Layer50]
	LoadActor("LOGO_WIRE.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X-4;y,SCREEN_CENTER_Y-35);
		OnCommand=cmd(diffusealpha,0;playcommand,"Animate");
		AnimateCommand=cmd(cropright,1;blend,'BlendMode_Add';diffusealpha,0;sleep,3.2;diffusealpha,0.8;linear,0.8;cropright,0;sleep,0.5;linear,0.3;diffusealpha,0;sleep,0.2;queuecommand,"Animate");
	};
	-- [Layer51]
	LoadActor("WIRE_DJ.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X-183;y,SCREEN_CENTER_Y-35);
		OnCommand=cmd(diffusealpha,0;playcommand,"Animate");
		AnimateCommand=cmd(blend,'BlendMode_Add';zoom,3.4;diffusealpha,0;sleep,3.4;linear,0.2;zoom,1;diffusealpha,0.8;sleep,0.9;linear,0.3;diffusealpha,0;sleep,0.2;queuecommand,"Animate");
	};
	-- [Layer52]
	LoadActor("WIRE_2DX.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X+45;y,SCREEN_CENTER_Y-88);
		OnCommand=cmd(diffusealpha,0;playcommand,"Animate");
		AnimateCommand=cmd(blend,'BlendMode_Add';diffusealpha,0.8;cropright,1;sleep,3.7;linear,0.3;cropright,0;sleep,0.5;linear,0.3;diffusealpha,0;sleep,0.2;queuecommand,"Animate");
	};
	-- [Layer53]
	LoadActor("WIRE_TROOPERS.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X+46;y,SCREEN_CENTER_Y-5);
		OnCommand=cmd(diffusealpha,0;playcommand,"Animate");
		AnimateCommand=cmd(blend,'BlendMode_Add';diffusealpha,0.8;cropright,1;sleep,3.8;linear,0.3;cropright,0;sleep,0.4;linear,0.3;diffusealpha,0;sleep,.2;queuecommand,"Animate");
	};
	-- [Layer55]
	Def.Sprite {
		Texture="HIBANA 3x4.png";
