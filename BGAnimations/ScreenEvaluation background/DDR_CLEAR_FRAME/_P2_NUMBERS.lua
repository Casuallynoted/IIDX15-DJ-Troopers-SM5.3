local t = Def.ActorFrame{
	...
	LoadFont("Evaluation Numbers")..{
	InitCommand=cmd(horizalign,left;vertalign,top;x,467;y,SCREEN_CENTER_Y+174);
	OnCommand=function(self,params)
		local stats = STATSMAN:GetCurStageStats():GetPlayerStageStats(PLAYER_2)
			str = string.format("%4d",
	...
	LoadFont("Evaluation Numbers")..{
	InitCommand=cmd(horizalign,right;vertalign,top;x,518;y,SCREEN_CENTER_Y-12);
	OnCommand=function(self,params)
		local stats = STATSMAN:GetCurStageStats():GetPlayerStageStats(PLAYER_2)
	...
	LoadFont("Evaluation Numbers")..{
	InitCommand=cmd(horizalign,right;vertalign,top;x,518;y,SCREEN_CENTER_Y+196);
	OnCommand=function(self,params)
