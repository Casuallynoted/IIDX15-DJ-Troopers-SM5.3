local t = Def.ActorFrame{
	...
	InitCommand=cmd(horizalign,right;vertalign,top;x,173;y,SCREEN_CENTER_Y+59);
	...
	LoadFont("Evaluation Numbers")..{
	InitCommand=cmd(horizalign,right;vertalign,top;x,173;y,SCREEN_CENTER_Y+174);
	OnCommand=function(self,params)
		local stats = STATSMAN:GetCurStageStats():GetPlayerStageStats(PLAYER_1)
			str = string.format("%4d",
	...
	LoadFont("Evaluation Numbers")..{
	InitCommand=cmd(horizalign,left;vertalign,top;x,122;y,SCREEN_CENTER_Y-12);
	OnCommand=function(self,params)
		local stats = STATSMAN:GetCurStageStats():GetPlayerStageStats(PLAYER_1)
	...
	LoadFont("Evaluation Numbers")..{
	InitCommand=cmd(horizalign,left;vertalign,top;x,122;y,SCREEN_CENTER_Y+196);
	OnCommand=function(self,params)
