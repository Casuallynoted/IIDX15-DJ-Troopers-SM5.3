local t = Def.ActorFrame{
	...
	-- Frame
	Def.Sprite{
		InitCommand=cmd(horizalign,left;x,20;y,240;animate,false);
	...
	-- Turntable
	Def.Sprite{
		InitCommand=cmd(horizalign,left;x,51;y,SCREEN_CENTER_Y+107;animate,true);
		BeginCommand=function(self)
	...
	-- Explosion
	Def.Sprite{
		InitCommand=cmd(blend,'BlendMode_Add';x,119;y,SCREEN_CENTER_Y+82;animate,true);
		BeginCommand=function(self)
