...
--[[ 		Def.Quad {
		...
		LoadFont("Common Normal") .. {
			...
			OnCommand=cmd(zoom,0.75;diffuseshift;effectcolor1,Color('White');effectcolor2,color("0.5,0.5,0.5"));
		};
	};
	table.insert( ret, t );
...
--[[ 	t = Def.BitmapText {
	...
	t = LoadFont("venacti/_venacti_outline 26px bold diffuse") .. {
		...
		InitCommand=cmd(y,30;maxwidth,270;zoom,0.6;shadowlength,1;uppercase,true);
	};
	table.insert( ret, t );
