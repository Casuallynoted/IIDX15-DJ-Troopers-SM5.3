...
GameColor = {
	...
	Difficulty = {
		...
		Beginner	= color("0.6392,0.9215,0.0078,1"),			-- light cyan
		Easy		= color("0,0.7568,0.8862,1"),			-- green
		Medium		= color("0.96875,0.6875,0,1"),			-- yellow
		Hard		= color("0.945,0,0,1"),			-- red
		Challenge	= color("0,0,0,1"),			-- light blue
		Edit		= color("0.44,0.44,0.44,1"),	-- gray
		...
		Difficulty_Beginner	= color("0.6392,0.9215,0.0078,1"),		-- purple
		Difficulty_Easy		= color("0,0.7568,0.8862,1"),		-- green
		Difficulty_Medium	= color("0.96875,0.6875,0,1"),		-- yellow
		Difficulty_Hard		= color("0.945,0,0,1"),		-- red
		Difficulty_Challenge	= color("0,0,0,1"),	-- light blue
