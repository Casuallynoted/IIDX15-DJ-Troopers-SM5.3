...
return Def.ActorFrame {
	...
	LoadActor("judge")..{
		Name="judgm";
		NormalCommand=cmd(diffusealpha,0.95;zoomx,1.05;zoomy,1.05;y,-5;linear,0.1;zoomx,0.8;zoomy,0.65;y,5;linear,0.45;diffusealpha,0.8;linear,0.4;zoomx,1.4;zoomy,0;diffusealpha,0)
	};
	--label
	LoadActor("label")..{
		Name="label";
		NormalCommand=cmd(y,30;linear,0;shadowlength,0;diffusealpha,1;zoomx,1;zoomy,1.4;linear,0.1;zoomx,0.9;zoomy,0.72;linear,0.45;diffusealpha,0.8;linear,0.4;zoomx,0.9;zoomy,0.72;diffusealpha,0)
	};
	--combo
	Def.BitmapText { File = "Combo.ini" }..{
		Name="combo";
		NormalCommand=cmd(y,48;linear,0;shadowlength,0;diffusealpha,1;zoomx,1;zoomy,1.4;linear,0.1;zoomx,0.9;zoomy,0.72;linear,0.45;diffusealpha,0.8;linear,0.4;zoomx,0.9;zoomy,0.72;diffusealpha,0)
	};
