...
return Def.ActorFrame {
	...
	LoadActor("judge")..{
		Name="judgm";
		NormalCommand=cmd(y,-20;diffusealpha,1;glow,color("1,1,1,0.4");shadowlength,0;zoomx,1.12;zoomy,1.48;linear,0.05;zoom,1;glow,color("1,1,1,0");diffuse,color("1,1,1,1");sleep,0.495;diffusealpha,0)
	};
	--combo
	Def.BitmapText { File = "Combo.ini" }..{
		Name="combo";
		NormalCommand=cmd(y,50;diffusealpha,1;glow,color("1,1,1,0.4");shadowlength,0;zoom,1.8;linear,0.05;zoom,1.2;glow,color("1,1,1,0");diffuse,color("1,1,1,1");sleep,0.495;diffusealpha,0)
	};
