local t = Def.ActorFrame {
	LoadActor("versus.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y-10;visible,GAMESTATE:GetCurrentGame():GetName() == "dance");
	...
	LoadActor("cursor-dance.png")..{
		InitCommand=cmd(blend,'BlendMode_Add';x,SCREEN_CENTER_X-1;y,SCREEN_CENTER_Y-10;visible,GAMESTATE:GetCurrentGame():GetName() == "dance");
		OnCommand=cmd(diffusealpha,0);
		GainFocusCommand=cmd(stoptweening;diffusealpha,1);
		LoseFocusCommand=cmd(stoptweening;diffusealpha,0);
		DisabledCommand=cmd(diffusealpha,0);
		EnabledCommand=cmd(diffusealpha,0);
	};
