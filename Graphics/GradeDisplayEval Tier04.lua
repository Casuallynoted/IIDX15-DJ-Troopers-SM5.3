local t = Def.ActorFrame {
	LoadActor(THEME:GetPathG("","grade/A.png"))..{
	InitCommand=cmd(vertalign,bottom;x,140;y,176);
	OnCommand=cmd(zoomy,10;diffusealpha,0;sleep,2.2;linear,0.1;zoomy,1;diffusealpha,1);
	};
	Def.Sprite {
