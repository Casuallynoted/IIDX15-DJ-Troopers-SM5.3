...
Def.Sprite {
	...
	LoadActor("texture/style2.png")..{
		...
		OnCommand=cmd(vertalign,top;;zoomy,100;diffusealpha,0;sleep,0.45;diffusealpha,1;linear,0.1;zoomy,1);
	...
	LoadActor("texture/style1.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X-144;y,SCREEN_CENTER_Y-136);
		OnCommand=cmd(vertalign,top;zoomy,100;diffusealpha,0;sleep,0.45;diffusealpha,1;linear,0.1;zoomy,1);
		OffCommand=cmd(diffusealpha,0);
	...
	LoadActor("texture/style3.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X-144;y,SCREEN_CENTER_Y-48);
		OnCommand=cmd(vertalign,top;zoomy,100;diffusealpha,0;sleep,0.45;diffusealpha,1;linear,0.1;zoomy,1);
		OffCommand=cmd(diffusealpha,0);
	...
	LoadActor("texture/style5.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X-143;y,SCREEN_CENTER_Y-48);
	...
	LoadActor("texture/MINI_DECIDE.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X-160;y,SCREEN_CENTER_Y-16);
		OnCommand=cmd(diffusealpha,0);
	...
	LoadActor("texture/beginner-name.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X-144;y,SCREEN_CENTER_Y-64);
		OnCommand=cmd(diffusealpha,0;sleep,.55;diffusealpha,1);
		OffCommand=cmd(diffusealpha,0);
		GainFocusCommand=cmd(stoptweening;diffusealpha,1);
		LoseFocusCommand=cmd(stoptweening;diffusealpha,1);
	};
