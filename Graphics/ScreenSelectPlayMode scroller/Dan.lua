...
Def.Sprite {
	...
	LoadActor("texture/style2.png")..{
		...
		OnCommand=cmd(vertalign,top;;zoomy,100;diffusealpha,0;sleep,0.6;diffusealpha,1;linear,0.1;zoomy,1);
	...
	LoadActor("texture/style5.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X+145;y,SCREEN_CENTER_Y-48);
	...
	LoadActor("texture/MINI_DECIDE.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X+128;y,SCREEN_CENTER_Y-16);
		OnCommand=cmd(diffusealpha,0);
	...
	LoadActor("texture/dan-name.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X+143;y,SCREEN_CENTER_Y-64);
		OnCommand=cmd(diffusealpha,0;sleep,.7;diffusealpha,1);
		OffCommand=cmd(diffusealpha,0);
		GainFocusCommand=cmd(stoptweening;diffusealpha,1);
		LoseFocusCommand=cmd(stoptweening;diffusealpha,1);
	};
