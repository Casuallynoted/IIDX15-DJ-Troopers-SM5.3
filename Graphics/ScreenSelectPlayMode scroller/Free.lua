...
Def.Sprite {
	...
	LoadActor("texture/style2.png")..{
		...
		OnCommand=cmd(vertalign,top;;zoomy,100;diffusealpha,0;sleep,0.65;diffusealpha,1;linear,0.1;zoomy,1);
	...
	LoadActor("texture/style5.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X+241;y,SCREEN_CENTER_Y-48);
	...
	LoadActor("texture/MINI_DECIDE.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X+224;y,SCREEN_CENTER_Y-16);
		OnCommand=cmd(diffusealpha,0);
	...
	LoadActor("texture/free-name.png")..{
		...
		OnCommand=cmd(diffusealpha,0;sleep,.75;diffusealpha,1);
		OffCommand=cmd(diffusealpha,0);
		GainFocusCommand=cmd(stoptweening;diffusealpha,1);
		LoseFocusCommand=cmd(stoptweening;diffusealpha,1);
	};
