local t = Def.ActorFrame {
	LoadActor("texture/_tutorial.png")..{
		...
		OnCommand=cmd(diffusealpha,0;sleep,.48;diffusealpha,1);
...
Def.Sprite {
	...
	LoadActor("texture/style2.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X-240;y,SCREEN_CENTER_Y-88);
		OnCommand=cmd(vertalign,top;;zoomy,100;diffusealpha,0;sleep,0.4;diffusealpha,1;linear,0.1;zoomy,1);
	...
	LoadActor("texture/style1.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X-240;y,SCREEN_CENTER_Y-136);
		OnCommand=cmd(vertalign,top;zoomy,100;diffusealpha,0;sleep,0.4;diffusealpha,1;linear,0.1;zoomy,1);
	...
	LoadActor("texture/style3.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X-240;y,SCREEN_CENTER_Y-48);
		OnCommand=cmd(vertalign,top;zoomy,100;diffusealpha,0;sleep,0.4;diffusealpha,1;linear,0.1;zoomy,1);
	...
	LoadActor("texture/style4.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X-240;y,SCREEN_CENTER_Y-48);
		OnCommand=cmd(diffusealpha,0;sleep,0.75;linear,0.2;diffusealpha,1;);
		GainFocusCommand=cmd(diffusealpha,0;linear,0.1;diffusealpha,1;);
		LoseFocusCommand=cmd(diffusealpha,0);
	};
	LoadActor("texture/style5.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X-239;y,SCREEN_CENTER_Y-48);
		OnCommand=cmd(blend,'BlendMode_Add';diffusealpha,0;sleep,0.75;diffusealpha,1);
		GainFocusCommand=cmd(blend,'BlendMode_Add';diffusealpha,0;linear,0.1;diffusealpha,1);
		LoseFocusCommand=cmd(diffusealpha,0);
	};
	LoadActor("texture/MINI_DECIDE.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X-256;y,SCREEN_CENTER_Y-16);
		OnCommand=cmd(diffusealpha,0;sleep,0.75;diffusealpha,1);
	...
	LoadActor("texture/tutorial-info.png")..{
		...
		OnCommand=cmd(diffusealpha,0;addy,-5;sleep,.5;linear,.2;addy,5;diffusealpha,1);
		GainFocusCommand=cmd(stoptweening;diffusealpha,0;y,SCREEN_CENTER_Y+125;linear,.2;y,SCREEN_CENTER_Y+130;diffusealpha,1);
		LoseFocusCommand=cmd(stoptweening;diffusealpha,0);
	};
	LoadActor("texture/tutorial-info.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y+130);
		OnCommand=cmd(blend,'BlendMode_Add';diffusealpha,0;sleep,.7;diffusealpha,1;linear,.05;diffusealpha,0;linear,.05;diffusealpha,1;linear,.05;diffusealpha,0);
	...
	LoadActor("texture/tutorial-name.png")..{
		InitCommand=cmd(x,SCREEN_CENTER_X-239;y,SCREEN_CENTER_Y-64);
		OnCommand=cmd(diffusealpha,0;sleep,.5;diffusealpha,1);
		GainFocusCommand=cmd(stoptweening;diffusealpha,1);
		LoseFocusCommand=cmd(stoptweening;diffusealpha,1);
	};
	--DECIDE--
